...
const SparklesPreview = () => {
  return (
    <div className="h-[20rem] w-full bg-gray-900 flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <div className="w-[100rem] h-40 relative">
        ...
        <div className="absolute inset-0 w-full h-full bg-gray-900 [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]" />
      </div>
    </div>
  )
}
